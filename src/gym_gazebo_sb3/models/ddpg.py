...
class DDPG(basic_model.BasicModel):
    ...
    def __init__(self, env, save_model_path, log_path, config_file_pkg="gym_gazebo_sb3", config_filename="ddpg_config.yaml", ns="/") -> None:
        """
        DDPG constructor.
        ...
        #--- Init super class
        super(DDPG, self).__init__(env, save_model_path, log_path)
